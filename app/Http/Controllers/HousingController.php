...
class HousingController extends Controller
{
    ...
    {
        $data=Basic::find($id);
        $activity=Housing::where('Society_Id', $id )->first();
        return view('pages.housing')->with(['Datas'=>$data,'activities'=>$activity]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $finddata= Housing::where('Society_Id', $id);
        $finddata->update($validatedData);
        $data=Basic::find($id);
        $activity=Housing::where('Society_Id', $id )->first();
        return view('pages.housing')->with(['Datas'=>$data,'activities'=>$activity,'msg'=>"Sucessfully Update!!"]);
    }
