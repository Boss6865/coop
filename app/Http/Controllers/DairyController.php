...
class DairyController extends Controller
{
    ...
    {
        $data=Basic::find($id);
        $activity=Dairy::where('Society_Id', $id )->first();
        return view('pages.dairy')->with(['Datas'=>$data,'activities'=>$activity]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $finddata= Dairy::where('Society_Id', $id);
        $finddata->update($validatedData);
        $data=Basic::find($id);
        $activity=Dairy::where('Society_Id', $id )->first();
        return view('pages.dairy')->with(['Datas'=>$data,'activities'=>$activity,'msg'=>"Sucessfully Update!!"]);
    }
