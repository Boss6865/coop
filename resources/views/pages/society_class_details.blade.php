...
<script src="https://cdn.datatables.net/fixedcolumns/5.0.4/js/fixedColumns.dataTables.js"></script>
      ...
      <x-navigation  Nav="Class of Society" />
         <!--begin::App Main-->
        <main class="app-main">
                ...
                <div class="col-12">
                  ...
                  <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">{{$District}} {{strtoupper($Class)}} Class Societies</h3>
                              ...
                              <div class="border rounded-lg border-gray-300 dt-container">
                                  ...
                                  <table class="stripe nowrap" style="width:100%" id="myTable">
                                      ...
                                      <tbody>
                                          ...
                                          <tr class='clickable-row' data-href="/details/{{$Society->Society_Id;}}">
                                            ...
                                            @foreach($Society->capital as $data)
                                              ...
                                              <td>
                                                  <button class="p-2  rounded-full bg-white group transition-all duration-500 ">
                                                    <a href="/details/{{$Society->Society_Id;}}">
